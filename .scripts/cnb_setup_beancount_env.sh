...
main() {
    ...
    echo "📌 build_beancount_gs "
    echo "📌 clone_example_beanbook"
    echo "📌 start_beancount_gs"
    echo "📌 setup_git_aliases"
    echo "📌 install_vscode_language_pack"
    echo "📌 patch_beancount_for_chinese"
    echo "📌 verify_installation"
    echo "📌 install_dependencies"
    echo "📌 create_venv"
    echo "📌 activate_venv"
    echo "📌 请使用 'gp' 命令快速推送 Beancount 更改"
    echo "📌 使用 'githelp' 查看所有可用命令"
    echo "📌 使用 'beancount-gs' 启动 Beancount 网页界面"
    echo "📌 使用 'beancount-gs -h' 查看 Beancount 网页界面帮助"
    echo "📌 使用 'beancount-gs -p 10000' 指定端口启动 Beancount 网页界面"
    echo "📌 使用 'beancount-gs -secret <密钥>' 指定密钥启动 Beancount 网页界面"
    echo "📌 使用 'beancount-gs -debug' 开启调试模式"
    echo "📌 使用 'beancount-gs -debug -p 10000 -secret <密钥>' 指定端口和密钥启动 Beancount 网页界面"
    echo "========================================"
}
